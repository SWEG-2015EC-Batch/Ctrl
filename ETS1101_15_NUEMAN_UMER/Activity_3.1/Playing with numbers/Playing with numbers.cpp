...
int main() {
    ...
    cout << "5. Print First and last digit and their sum\n";
    cout << "6. Swap first and last digit\n";
    cout << "7. Check if it is palindrome\n";
    cout << "8. Frequency of each digit \n";
    cout << "9. Check if it is Armstrong number\n";
    cout << "10. Check if it is  Strong number\n";
    cout << "11. Check if it is Perfect number\n";
